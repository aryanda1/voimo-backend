import openai
import time
openai.api_key = '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'
...
def prompts(maxFrame,theme='',artists='',choice = 0):
  ...
  if choice<2:
    ...
    if newScenes[0][0]=='1':
        newScenes = "\n".join([sent[3:] for sent in newScenes.split('\n')])
    # print('kk')
    time.sleep(20)
    newKey = gptResponse('U take input as muliple scenes, and extract 4 keywords from each scene. And the final length of each scene keyword should be under 100 characters',newScenes)
