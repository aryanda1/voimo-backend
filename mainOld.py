...
def musictoVid(device,model,mp3_path,theme,artist,option,upscale,timestring):
  ...
  if option<2:
    saveLyrics(vocalsPath,output_path)
  ...
  render_animation(args, anim_args,device,model)
  if upscale:
